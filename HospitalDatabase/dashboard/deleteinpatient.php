...
<div class="container" style="margin-left:240px;">
	...
	<?php
		...
		$Query = "Select d.patient_id,d.patient_name,d.patient_gender,d1.doctor_name from inpatient_detail d
			...
			while($rows = mysqli_fetch_assoc($stmt))
			{
				...
				echo"<form action=../manipulation/manipulatedb.php method=POST><tbody>
      					<tr>
							...
							<td><input type='hidden' name=id value={$rows['patient_id']}><input class='btn btn-default' type=submit name=deletein value=delete></td>
						 </tr>
						 </tbody></form>
            			 ";
			}
