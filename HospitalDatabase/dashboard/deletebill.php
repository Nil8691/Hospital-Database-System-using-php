...
<div class="container" style="margin-left:240px;">
    ...
    <h1 style="margin-left:30px;">Delete Bill Report</h1>      
  </div>
	<?php
			...
			while($rows = mysqli_fetch_assoc($stmt))
			{
				...
				echo"<form action=../manipulation/manipulatedb.php method=POST><tbody>
      					<tr>
							...
							<td><input type='hidden' name=id value={$rows['bill_number']}><input class='btn btn-default' type=submit name=deletebill value=delete></td>
						 </tr>
						 </tbody></form>
            			 ";
			}
